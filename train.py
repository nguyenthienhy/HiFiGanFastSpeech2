        ...
        for i, batch in enumerate(train_loader):
            ...
            if rank == 0:
                ...
                if steps % a.checkpoint_interval == 0 and steps != 0:
                    checkpoint_path_prev = glob.glob("cp_hifigan/*.pth.tar")
                    for ch in checkpoint_path_prev:
                        os.remove(ch)
                    print("Saving checkpoint to " + "{}/g_{:08d}.pth.tar".format(a.checkpoint_path, steps))
                    torch.save(
                        {
                        ...
                        os.path.join(
                            "{}/g_{:08d}.pth.tar".format(a.checkpoint_path, steps)
                        ),
                    )
...
def main():
    ...
    parser.add_argument('--input_wavs_dir', default='data/vn')
    parser.add_argument('--input_mels_dir', default='data/mel')
